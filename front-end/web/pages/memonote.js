      ...
      <div>
        ...
        >
          ...
          {props.status === "Unresolved" ? (
            <div style={{ color: "red" }}>&nbsp;[미종결]</div>
          ) : (
            <div style={{ color: "green" }}>&nbsp;[종결]</div>
          )}
        </p>
        <div className={Styles.headerType}>
          <Row justify="end" gutter={12}>
            ...
            <Col
              style={{ margin: "0px" }}
              className={(() => {
                if (props.level == "1") return Styles.severityLevel1;
                if (props.level == "2") return Styles.severityLevel2;
                if (props.level == "3") return Styles.severityLevel3;
                if (props.level == "4") return Styles.severityLevel4;
                if (props.level == "5") return Styles.severityLevel5;
                return "";
              })()}
            >
              중요도: {props.level}
  ...
  return (
    <>
      ...
      <Layout className={Styles.mainLayout}>
        <Layout.Sider className={Styles.siderLayout} width={400}>
          <div className={Styles.siderMenu}>
              ...
              <Row align="middle" justify="space-between">
                <Col>
                  <div className="memonoteSiderTitle">
                    ...
                    >
                      <Select.Option value="receiveMemo">
                        받은 메모 보고
                      </Select.Option>
                      <Select.Option value="sendMemo">
                        보낸 메모 보고
                      </Select.Option>
                    </Select>
                  </div>
            ...
            <div className={Styles.scrollableDiv}>
              <List
                ...
                dataSource={memoRenderList.filter(
                  (list) =>
                    list.Title.includes(memoFilter) ||
                    list.Content.includes(memoFilter)
                )}
      ...
      <MemoForm
        setMemoRenderList={setMemoRenderList}
        memonoteType={memonoteType}
        setMemonoteType={setMemonoteType}
        isOpen={formOpened}
